...
user in an INI file next to BitwardenPortable.exe called BitwardenPortable.ini.
...
copy AppNamePortable.ini from this directory to BitwardenPortable.ini next to
BitwardenPortable.exe. The options in the INI file are as follows:
